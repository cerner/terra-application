...
The NavigationPrompt communicates with [NavigationPromptCheckpoints](/components/terra-application/application/reference/components/navigation-prompt-checkpoint)
