...
const PendingActionsCard = () => {
  ...
  return (
    <Card title="Pending Actions">
      ...
      <p>
        <Button icon={hasPendingAction1 && <IconWarning />} text={`${hasPendingAction1 ? 'De-activate' : 'Activate'} Pending Action 1`} onClick={() => { setHasPendingAction1(!hasPendingAction1); }} />
      </p>
      <p>
        <Button icon={hasPendingAction2 && <IconWarning />} text={`${hasPendingAction2 ? 'De-activate' : 'Activate'} Pending Action 2`} onClick={() => { setHasPendingAction2(!hasPendingAction2); }} />
      </p>
