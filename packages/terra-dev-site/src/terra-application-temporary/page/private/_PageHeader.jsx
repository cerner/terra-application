...
import ActionMenu, {
  ActionMenuItem,
} from '@cerner/terra-application/lib/action-menu';
import { useTransientPresentationState } from '@cerner/terra-application/lib/utils/transient-presentations';
      ...
      <div className={cx('page-header')}>
        {onBack || pageContainerContext?.containerStartActions ? (
          <div className={cx('back-button-container')}>
            {pageContainerContext.containerStartActions && pageContainerContext.containerStartActions.length ? (
              <>
        ...
        <div className={cx('end-actions-container')}>
          ...
          {renderMenuButton()}
          {showMenu && renderMenu()}
          {pageContainerContext.containerEndActions && pageContainerContext.containerEndActions.length ? (
            <>
              <div className={cx('actions-divider')} />
