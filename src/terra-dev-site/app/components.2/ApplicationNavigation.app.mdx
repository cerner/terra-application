...
ApplicationNavigation monitors its children for the presence of rendered [UnsavedChangesPrompts](/application/cerner-terra-application/components/navigation-prompt)
by rendering a [UnsavedChangesPromptCheckpoint](/application/cerner-terra-application/components/navigation-prompt-checkpoint) around its children.
