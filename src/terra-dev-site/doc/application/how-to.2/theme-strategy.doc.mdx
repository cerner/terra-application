...
See the [WDIO documentation](https://github.com/cerner/terra-toolkit-boneyard/tree/master/scripts/wdio#terra-toolkit-wdio-helpers) additional information and configuration options.
