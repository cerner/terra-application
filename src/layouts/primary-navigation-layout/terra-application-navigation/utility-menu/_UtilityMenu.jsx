...
const UtilityMenu = ({
  ...
  return (
    <PopupMenu
      role="listbox"
      title={intl.formatMessage({ id: 'terraApplication.applicationNavigation.utilityMenu.headerTitle' })}
      footerText={intl.formatMessage({ id: 'terraApplication.applicationNavigation.utilityMenu.logout' })}
