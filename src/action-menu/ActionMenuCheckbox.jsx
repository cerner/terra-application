...
import styles from './ActionMenuCheckbox.module.scss';
...
const ActionMenuCheckbox = ({
  ...
  return (
    <li
      {...attrs}
      className={cx('action-menu-checkbox', { 'is-checked': isChecked }, { 'is-actionable': !isDisabled }, { 'is-disabled': isDisabled }, theme.className)}
