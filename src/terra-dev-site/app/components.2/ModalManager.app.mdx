...
ModalManager renders an [ApplicationErrorBoundary](/application/terra-application/application/application/application-error-boundary)
...
ModalManager renders an [ApplicationLoadingOverlayProvider](/application/terra-application/application/application/application-loading-overlay)
...
ModalManager renders an [ApplicationPageStatusProvider](/application/terra-application/components/application-page-status-provider)
...
> If the disclosed modal contents do not utilize the DisclosureManagerHeaderAdapter and render their own modal header instead,
> it is recommended that those components render an additional ApplicationPageStatusProvider below their modal header to keep
> the header controls for modal dismissal exposed while the status view is active.

### Unsaved Changes

ModalManager monitors its disclosed content for the presence of rendered [NavigationPrompts](/application/terra-application/application/application/navigation-prompt)
...
The ModalManager utilizes the [DisclosureManagerContext](/application/terra-application/application/contexts/disclosure-manager-context) to manage disclosure requests.
