...
SlidePanelManager monitors its disclosed content for the presence of rendered [UnsavedChangesPrompts](/application/cerner-terra-application/components/navigation-prompt)
...
[UnsavedChangesPrompts](/application/cerner-terra-application/components/navigation-prompt) are rendered at the time of the dismissal request.
