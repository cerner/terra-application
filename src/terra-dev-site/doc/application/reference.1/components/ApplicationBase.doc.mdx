...
ApplicationBase exposes a prop from defining the application's locale. ApplicationBase renders an [ApplicationIntlContext](/components/terra-application/application/reference/contexts/application-intl-context).Provider around its children. Children can access the intl APIs by using the [ApplicationIntlContext](/components/terra-application/application/reference/contexts/application-intl-context)).
