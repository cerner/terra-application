...
const UnselectedTabCenter = (customProps) => {
  ...
  return (
    <IconBase {...customProps}>
      ...
      <defs>
        <rect id="path-1" x="0" y="0" width="2" height="40"></rect>
      ...
      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Group-Copy-29">
          ...
          <g id="Mask" transform="translate(1.000000, 20.000000) scale(-1, 1) translate(-1.000000, -20.000000) "></g>
          <g mask="url(#mask-2)" id="🚫tab-body-copy-12">
...
UnselectedTabCenter.displayName = "UnselectedTabCenter";
UnselectedTabCenter.defaultProps = {"viewBox":"0 0 48 48","xmlns":"http://www.w3.org/2000/svg"};

export default UnselectedTabCenter;
/* eslint-enable */
