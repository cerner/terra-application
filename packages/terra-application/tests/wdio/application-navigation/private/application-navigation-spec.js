Terra.describeViewports('ApplicationNavigation - Large', ['large'], () => {
  describe('Extensions roll up properly', () => {
    it('launch popup', () => {
      browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/extensions');
  ...
  describe('Tabs roll up properly', () => {
    it('launch popup', () => {
      browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/tabs');
  ...
  describe('Utilities should display properly', () => {
    it('launch popup', () => {
      browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/utilities');
  ...
  describe('Utilities should display properly when only help, settings or logout utilities are present', () => {
    it('launch popup', () => {
      browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/no-custom-utility-items');
      $('[data-application-header-utility="true"]').click();
      $('[data-terra-popup-content="true"]').waitForDisplayed();
      browser.pause(50);
  ...
  describe('Utilities should display properly when only custom utility items are specified', () => {
    it('launch popup', () => {
      browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/only-custom-utility-items');
      $('[data-application-header-utility="true"]').click();
      $('[data-terra-popup-content="true"]').waitForDisplayed();
      browser.pause(50);
  ...
  describe('Hero should display properly', () => {
    it('launch popup', () => {
      browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/hero');
      $('[data-application-header-utility="true"]').click();
      $('[data-terra-popup-content="true"]').waitForDisplayed();
      browser.pause(50);
  ...
  it('should display username properly', () => {
    browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/user');
    Terra.validates.element('display username');
  });

  it('should display title properly', () => {
    browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/title');
...
Terra.describeViewports('ApplicationNavigation - Small', ['small'], () => {
  ...
  describe('Hero enters the nav drawer', () => {
    it('open drawer', () => {
      browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/hero-drawer');
      $('[data-compact-header-toggle="true"]').waitForDisplayed();
      $('[data-compact-header-toggle="true"]').click();
      browser.pause(250);
  ...
  describe('Hero and User enters the nav drawer', () => {
    it('open drawer', () => {
      browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/hero-and-user');
      $('[data-compact-header-toggle="true"]').waitForDisplayed();
      $('[data-compact-header-toggle="true"]').click();
      browser.pause(250);
  ...
  describe('ApplicationNotifications displays the nav drawer', () => {
    it('open drawer', () => {
      browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/application-notifications');
      $('[data-compact-header-toggle="true"]').waitForDisplayed();
      $('[data-compact-header-toggle="true"]').click();
      browser.pause(500);
...
Terra.describeViewports('ApplicationNavigation', ['large', 'huge', 'enormous'], () => {
  describe('Should open selected item when alert is accepted', () => {
    it('Dismiss alert', () => {
      browser.url('/raw/tests/terra-application/application-navigation/private/application-navigation/application-navigation-prompt-focus');
