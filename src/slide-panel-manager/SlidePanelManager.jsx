...
const SlidePanelManager = ({ unsavedChangesPromptResolutionOptions, ...terraSlidePanelManagerProps }) => (
  <TerraSlidePanelManager
    {...terraSlidePanelManagerProps}
    withDisclosureContainer={disclosureContent => (
      <DisclosureContainer unsavedChangesPromptResolutionOptions={unsavedChangesPromptResolutionOptions}>
        {disclosureContent}
      </DisclosureContainer>
    )}
  />
