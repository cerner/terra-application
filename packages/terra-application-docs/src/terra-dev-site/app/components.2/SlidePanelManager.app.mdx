import PropsTable from '@cerner/terra-application/lib/slide-panel-manager/SlidePanelManager?dev-site-props-table';
...
[DisclosureManagerContext](/application/cerner-terra-application-docs/contexts/disclosure-manager-context).

## Usage

```jsx
import SlidePanelManager from '@cerner/terra-application/lib/slide-panel-manager';
```
...
SlidePanelManager renders an [ApplicationErrorBoundary](/application/cerner-terra-application-docs/components/application-error-boundary)
...
SlidePanelManager renders an [ApplicationLoadingOverlayProvider](/application/cerner-terra-application-docs/components/application-loading-overlay-provider)
around its disclosed components. Any [ApplicationLoadingOverlay](/application/cerner-terra-application-docs/components/application-loading-overlay)
...
SlidePanelManager renders an [ApplicationStatusOverlayProvider](/application/cerner-terra-application-docs/components/application-status-overlay-provider)
around its disclosed components. Any [ApplicationStatusOverlay](/application/cerner-terra-application-docs/components/application-status-overlay)
...
SlidePanelManager monitors its disclosed content for the presence of rendered [UnsavedChangesPrompts](/application/cerner-terra-application-docs/components/unsaved-changes-prompt)
...
[UnsavedChangesPrompts](/application/cerner-terra-application-docs/components/unsaved-changes-prompt) are rendered at the time of the dismissal request.

## Details

### Implementation Requirements

The SlidePanelManager utilizes the [DisclosureManagerContext](/application/cerner-terra-application-docs/contexts/disclosure-manager-context) to manage disclosure requests.
...
import SlidePanelManager, { disclosureType } from '@cerner/terra-application/lib/slide-panel-manager';
import { withDisclosureManager, DisclosureManagerContext, DisclosureManagerHeaderAdapter } from '@cerner/terra-application/lib/disclosure-manager';
