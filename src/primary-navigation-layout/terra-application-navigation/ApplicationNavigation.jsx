...
import {
  titleConfigPropType, userConfigPropType, navigationItemsPropType,
  extensionItemsPropType, utilityItemsPropType,
...
const ApplicationNavigation = ({
  ...
  const [drawerMenuIsOpen, setDrawerMenuIsOpen] = useTransientPresentationState(false);
  const [popupMenuIsOpen, setPopupMenuIsOpen] = useTransientPresentationState(false);
  ...
  /**
   * This effect executes  if the drawer menu has been opened or closed during
   * the last update, or if the provided callback reference has changed.
   */
  useEffect(() => {
    ...
    <div className={cx('application-navigation', theme.className)}>
      ...
      >
        ...
        <Overlay
          ...
          zIndex="6000"
          onRequestClose={generateFocusToggle((event) => {
