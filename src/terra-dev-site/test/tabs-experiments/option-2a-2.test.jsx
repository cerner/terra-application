...
import Workspace, { WorkspaceItem } from "../../../workspace-2a-2";
import ActiveMainPageContext from "../../../application-container/private/active-main-page/ActiveMainPageContext";
import Tab1 from "./option-2a-2-tabs/Tab2";
import Tab2 from "./option-2a-2-tabs/Tab2";
import Tab3 from "./option-2a-2-tabs/Tab3";
import Tab4 from "./option-2a-2-tabs/Tab4";
import Tab5 from "./option-2a-2-tabs/Tab5";
import Tab6 from "./option-2a-2-tabs/Tab6";
