...
By default, the DisclosureManager monitors its disclosed content for the presence of [NavigationPrompts](/application/cerner-terra-application/components/navigation-prompt).
...
Any component that uses `registerDismissCheck` should check for the presence of NavigationPrompts (using a [NavigationPromptCheckpoint](/application/cerner-terra-application/components/navigation-prompt-checkpoint))
