...
const Workspace = ({
  ...
  let [newResizeClass, setNewResizeClass] = useState("NONE");

  const lafuncion = (val) => {
    if (val <= 300) {
      setNewResizeClass("small-adjustment-css");
    }
  };
  ...
  return (
    ...
    >
      <div className={cx("workspace")} role="none">
        ...
        <div
          role="none"
          className={cx("tab-header", newResizeClass, {
            "has-dismiss-button": onRequestDismiss && dismissButtonIsVisible,
          })}
        >
          <Tabs ariaLabel={ariaLabel} tabData={tabData} lafuncion={lafuncion} />
        </div>
