...
[ApplicationLoadingOverlayProvider](/application/terra-application/application/application/application-loading-overlay-provider) to
present a loading overlay.

> See the [How to Show Loading Overlays](/application/terra-application/application/how-to/show-loading-overlays) page for usage information.
