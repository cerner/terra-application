...
|method|syntax|Default Behaviour|
|---|---|---|
...
|`onWarn`|function|optional|undefined|The method to override the default info logging method.|
|`onError`|function|optional|undefined|The method to override the default info logging method.|
