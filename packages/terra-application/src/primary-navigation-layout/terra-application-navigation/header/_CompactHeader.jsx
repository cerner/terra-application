  ...
  function renderMenuButton() {
    ...
    return (
      <div
        ...
        aria-label={intl.formatMessage({ id: 'terraApplication.applicationNavigation.header.menuButtonTitle' })}
  ...
  function buildUtilityItems() {
    ...
    return (
      ...
      >
        ...
        {onSelectSettings ? (
          buildUtilityItem(intl.formatMessage({ id: 'terraApplication.applicationNavigation.utilityMenu.settings' }), 'app-menu-settings', generateCloseUtilsFunc(onSelectSettings), utilitiesIsOpen, id)
        ) : null}
        {onSelectHelp ? (
          buildUtilityItem(intl.formatMessage({ id: 'terraApplication.applicationNavigation.utilityMenu.help' }), 'app-menu-help', generateCloseUtilsFunc(onSelectHelp), utilitiesIsOpen, id)
        ) : null}
        {onSelectLogout ? (
          buildUtilityItem(intl.formatMessage({ id: 'terraApplication.applicationNavigation.utilityMenu.logout' }), 'app-menu-logout', generateCloseUtilsFunc(onSelectLogout), utilitiesIsOpen, id)
        ) : null}
      </ul>
    );
  }
