...
* [terra/custom-property-name](/dev_tools/terra-application-docs/stylelint-config-terra/custom-rules/custom-property-name): Requires custom properties to be suffixed with the css property name.
* [terra/custom-property-namespace](/dev_tools/terra-application-docs/stylelint-config-terra/custom-rules/custom-property-namespace): Requires custom properties to be prefixed with a namespace.
* [terra/custom-property-no-duplication-declaration](/dev_tools/terra-application-docs/stylelint-config-terra/custom-rules/custom-property-no-duplicate-declaration): Disallows a custom property to be declared more than once with a different fallback value.
* [terra/custom-property-pattern](/dev_tools/terra-application-docs/stylelint-config-terra/custom-rules/custom-property-pattern): Requires custom properties to be written in lowercase alphanumeric characters and hyphens.
* [terra/custom-property-pseudo-selectors](/dev_tools/terra-application-docs/stylelint-config-terra/custom-rules/custom-property-pseudo-selectors): Requires custom properties to include all ancestor pseudo selectors in order.
