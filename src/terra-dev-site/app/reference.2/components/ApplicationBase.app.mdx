...
ApplicationBase exposes a prop to define the application's locale and dynamically retrieve the translated strings for that locale. Children of ApplicationBase can access translated strings by using [react-intl's](https://github.com/formatjs/react-intl) provided components or by using the [ApplicationIntlContext](/components/terra-application/application/reference/contexts/application-intl-context).
...
ApplicationBase renders a [ModalManager](/components/terra-application/application/reference/components/modal-manager) around its children. Children can access modal disclosure APIs by using the [DisclosureManagerContext](/components/terra-application/application/reference/contexts/disclosure-manager-context).