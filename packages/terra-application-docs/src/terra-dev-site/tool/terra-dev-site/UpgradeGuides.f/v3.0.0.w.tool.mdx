...
## Dependency Changes
All terra dependencies were updated to consume their latest major versions. These major version changes updated the CSS Custom properties and require no code changes. Webpack still aliases local terra versions so this does not affect local development.
