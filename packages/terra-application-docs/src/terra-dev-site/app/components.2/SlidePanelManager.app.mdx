...
SlidePanelManager monitors its disclosed content for the presence of rendered [NavigationPrompts](/application/cerner-terra-application-docs/components/navigation-prompt)
...
[NavigationPrompts](/application/cerner-terra-application-docs/components/navigation-prompt) are rendered at the time of the dismissal request.
