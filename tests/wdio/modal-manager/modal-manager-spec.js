...
Terra.describeViewports('ModalManager', ['tiny', 'large'], () => {
  before(() => browser.url('/#/raw/tests/terra-application/modal-manager/modal-manager-default').refresh());
...
Terra.describeViewports('ModalManager - Behaviors', ['large'], () => {
  describe('Behaviors', () => {
    before(() => browser.url('/#/raw/tests/terra-application/modal-manager/modal-manager-default')
      .refresh());
  ...
  describe('Component Integration', () => {
    before(() => browser.url('/#/raw/tests/terra-application/modal-manager/modal-manager-integration'));
