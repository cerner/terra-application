...
Every child of [ApplicationBase](/application/cerner-terra-application/components/application-base) has access to the
...
Additionally, ApplicateBase provides react-intl's APIs through the [ApplicationIntlContext](/application/cerner-terra-application/contexts/application-intl-context)
