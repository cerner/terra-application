...
[DisclosureManagerContext](/application/cerner-terra-application/contexts/disclosure-manager-context).
...
SlidePanelManager renders an [ApplicationErrorBoundary](/application/cerner-terra-application/components/application-error-boundary)
...
SlidePanelManager renders an [ApplicationLoadingOverlayProvider](/application/cerner-terra-application/components/application-loading-overlay-provider)
around its disclosed components. Any [ApplicationLoadingOverlay](/application/cerner-terra-application/components/application-loading-overlay)
...
SlidePanelManager renders an [ApplicationStatusOverlayProvider](/application/cerner-terra-application/components/application-status-overlay-provider)
around its disclosed components. Any [ApplicationStatusOverlay](/application/cerner-terra-application/components/application-status-overlay)
...
SlidePanelManager monitors its disclosed content for the presence of rendered [UnsavedChangesPrompts](/application/cerner-terra-application/components/unsaved-changes-prompt)
...
[UnsavedChangesPrompts](/application/cerner-terra-application/components/unsaved-changes-prompt) are rendered at the time of the dismissal request.

## Details

### Implementation Requirements

The SlidePanelManager utilizes the [DisclosureManagerContext](/application/cerner-terra-application/contexts/disclosure-manager-context) to manage disclosure requests.
