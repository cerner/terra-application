...
By default, the DisclosureManager monitors its disclosed content for the presence of [UnsavedChangesPrompts](/application/cerner-terra-application/components/navigation-prompt).
...
Any component that uses `registerDismissCheck` should check for the presence of UnsavedChangesPrompts (using a [UnsavedChangesPromptCheckpoint](/application/cerner-terra-application/components/navigation-prompt-checkpoint))
