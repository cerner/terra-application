...
const propTypes = {
   ...
   */
  supportedDisclosureTypes: PropTypes.array, // eslint-disable-line react/forbid-prop-types
  /**
   ...
   * to this prop value may not be reflected for existing disclosed content.
   */
...
class DisclosureManager extends React.Component {
  ...
  generateDisclosureComponentMappingForRender() {
    const { navigationPromptResolutionOptions } = this.props;
