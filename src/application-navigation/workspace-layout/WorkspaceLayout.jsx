...
const WorkspaceLayout = ({
  ...
  const layoutContextValue = React.useMemo(() => {
    return ({
      show: () => setWorkspaceIsVisible(true),
      hide: () => setWorkspaceIsVisible(false),
      hasWorkspace,
      workspaceIsVisible,
    });
  }, [hasWorkspace, workspaceIsVisible, setWorkspaceIsVisible]);
  ...
  const renderWorkspaceSkipToLink = () => {
    ...
    // TODO: kasper hardcode a skip to link
    // return (
    //   <SkipToLink
