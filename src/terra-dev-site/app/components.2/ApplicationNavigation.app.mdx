...
ApplicationNavigation renders an [ApplicationPageStatusProvider](/application/terra-application/components/application-page-status-provider) around its children.
Any [ApplicationPageStatus](/application/terra-application/components/application-page-status) components rendered by children will cause a status view
to be presented over ApplicationNavigation's children.
