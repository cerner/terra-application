...
ApplicationNavigation monitors its children for the presence of rendered [NavigationPrompts](/application/cerner-terra-application-docs/components/navigation-prompt)
by rendering a [NavigationPromptCheckpoint](/application/cerner-terra-application-docs/components/navigation-prompt-checkpoint) around its children.
