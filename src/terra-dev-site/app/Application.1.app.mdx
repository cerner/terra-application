...
Notification Banner are used as a notification to display information that needs to be brought to the user's attention. This is a common application pattern than often requires strategic placement and ordering with an application to correctly notify the user when something happened. Orion application provided Banner management to align with these needs.
