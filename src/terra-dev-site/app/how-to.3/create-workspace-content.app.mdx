...
Consumers of the [ApplicationNavigation](application/terra-application/components/application-navigation) component are responsible for defining the overall structure of its workspace.
