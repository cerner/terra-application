...
ApplicationBase renders an [ApplicationPageStatusProvider](/application/terra-application/components/application-page-status-provider) around its children. Any [ApplicationPageStatus](/application/terra-application/components/application-page-status) components rendered by children will result in a status view being rendered by ApplicationBase.
