...
* Application Concept
  * Define API for specifying page/modal banners
...
* Side Nav Layout
  * Determine data persistance expectations
* Modals
  * Consume Application Concept API
  * Determine stacking patterns
  * Inert implementation
  * Better sizing API
  * Header/Footer Actions API
  * NotificationBanner Integration
* Popups
  * Implementation with LayerPortal and everything that comes with it
* Notification Dialog
  * Implementation with LayerPortal and everything that comes with it
