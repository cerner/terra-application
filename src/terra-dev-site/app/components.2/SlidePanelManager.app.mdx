...
SlidePanelManager monitors its disclosed content for the presence of rendered [NavigationPrompts](/application/cerner-terra-application/components/navigation-prompt)
...
[NavigationPrompts](/application/cerner-terra-application/components/navigation-prompt) are rendered at the time of the dismissal request.
