import ApplicationLoadingOverlayProviderProps from '@cerner/terra-application/lib/application-loading-overlay/ApplicationLoadingOverlayProvider?dev-site-props-table';

# ApplicationLoadingOverlayProvider

The ApplicationLoadingOverlayProvider defines a container within which loading overlays may be presented.

[ApplicationLoadingOverlay](/application/cerner-terra-application-docs/components/application-loading-overlay) components rendered by children of the ApplicationLoadingOverlayProvider will cause the
