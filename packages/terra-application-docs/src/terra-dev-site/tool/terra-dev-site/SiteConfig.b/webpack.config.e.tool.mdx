# Webpack Config
[This webpack config](https://github.com/cerner/terra-application/blob/main/packages/terra-dev-site/config/webpack/terra-dev-site.webpack.config.js) is the entry point for spinning up terra-dev-site. By either extending or using directly terra-dev-site's webpack config, the site will render with either the custom or default site config.
...
## Points of interest
* Extends [terra-toolkit webpack config](https://github.com/cerner/terra-application/blob/main/packages/terra-dev-site/config/webpack/webpack.config.js).
