...
ModalManager renders an [ApplicationErrorBoundary](/application/cerner-terra-application/components/application-error-boundary)
...
ModalManager renders an [ApplicationLoadingOverlayProvider](/application/cerner-terra-application/components/application-loading-overlay-provider)
...
ModalManager renders an [ApplicationStatusOverlayProvider](/application/cerner-terra-application/components/application-status-overlay-provider)
...
ModalManager monitors its disclosed content for the presence of rendered [UnsavedChangesPrompts](/application/cerner-terra-application/components/unsaved-changes-prompt)
...
The ModalManager utilizes the [DisclosureManagerContext](/application/cerner-terra-application/contexts/disclosure-manager-context) to manage disclosure requests.
