...
By default, the DisclosureManager monitors its disclosed content for the presence of [NavigationPrompts](/application/terra-application/application/application/navigation-prompt).
...
Any component that uses `registerDismissCheck` should check for the presence of NavigationPrompts (using a [NavigationPromptCheckpoint](/application/terra-application/application/application/navigation-prompt-checkpoing))
