...
for teams that want to migrate to v2 without using pages.
...
EventEmitter based API for dismissing transient content. Paired with custom useTransientState hook with listener built in.

Need to determine need for this.
