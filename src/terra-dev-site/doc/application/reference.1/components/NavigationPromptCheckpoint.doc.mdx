...
The NavigationPromptCheckpoint serves as a registration gateway for [NavigationPrompts](/components/terra-application/application/reference/components/navigation-prompt)
