...
[DisclosureManagerContext](/application/terra-application/application/contexts/disclosure-manager-context).
...
SlidePanelManager renders an [ApplicationErrorBoundary](/application/terra-application/application/application/application-error-boundary)
...
SlidePanelManager renders an [ApplicationLoadingOverlayProvider](/application/terra-application/application/application/application-loading-overlay)
around its disclosed components. Any [ApplicationLoadingOverlay](/application/terra-application/application/application/application-loading-overlay)
...
SlidePanelManager renders an [ApplicationPageStatusProvider](/application/terra-application/components/application-page-status-provider)
around its disclosed components. Any [ApplicationPageStatus](/application/terra-application/components/application-page-status)
components rendered by children will cause a status view to be rendered over the panel's contents.

> If the disclosed panel contents do not utilize the DisclosureManagerHeaderAdapter and render their own panel header instead,
> it is recommended that those components render an additional ApplicationPageStatusProvider below their panel header to keep
> the header controls for panel dismissal exposed while the status view is active.

### Unsaved Changes

SlidePanelManager monitors its disclosed content for the presence of rendered [NavigationPrompts](/application/terra-application/application/application/navigation-prompt)
...
[NavigationPrompts](/application/terra-application/application/application/navigation-prompt) are rendered at the time of the dismissal request.

## Details

### Implementation Requirements

The SlidePanelManager utilizes the [DisclosureManagerContext](/application/terra-application/application/contexts/disclosure-manager-context) to manage disclosure requests.
