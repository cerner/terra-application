...
A `terra-theme.config.js` file must be available to enable themes. Check out the [theme strategy guide](/guides/cerner-terra-application/theme-strategy) for more information about using and applying themes.
