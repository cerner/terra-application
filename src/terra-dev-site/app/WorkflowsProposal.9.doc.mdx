...
* think about scroll persistance with unmounting navigation content
  ...
  * might add checks to layouts to cache prior to active nav item changing
  * Pages might need something similar but it'll be trickier
...
* Splash Screen
* Rethink PageContainerActionsContext
