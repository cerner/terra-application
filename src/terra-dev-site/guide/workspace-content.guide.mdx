...
Workspace is composed of a Workspace component and child WorkspaceItems. The WorkspaceItem is comprised on the necessary labels, identifiers, and a render block. Within the render block a WorkspaceContent component should be yielded.
...
If any of your components content will be displayed underneath the overlay ensure that it they are set as disabled, both visually and for asssitive technology.
...
### Should I provide my own scrolling via terra-scroll or terra-content-container?
...
### Can my component rely on cross-communication or state from other areas within an application?

No, content should be designed with the expectation that its fully standalone and any cross information/communication is done through back-end services not front-end messaging.
