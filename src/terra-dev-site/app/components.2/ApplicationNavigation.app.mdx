...
The `workspace` prop allows consumers to display a workspace aside region by providing an ApplicationNavigationWorkspace with associated ApplicationNavigationWorkspaceItems.
The ApplicationNavigationWorkspace provides the ability to initialize and monitor the state of the WorkspaceLayout through callbacks.
