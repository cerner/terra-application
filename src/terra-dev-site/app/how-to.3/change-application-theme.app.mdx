...
A `terra-theme.config.js` file must be available to enable themes. Check out the [theme strategy guide](/application/terra-application/how-to/theme-strategy) for more information about using and applying themes.
