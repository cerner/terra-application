import ApplicationStatusOverlayProviderProps from '@cerner/terra-application/lib/application-status-overlay/ApplicationStatusOverlayProvider?dev-site-props-table';

# ApplicationStatusOverlayProvider

The ApplicationStatusOverlayProvider defines a container within which a Status View may be presented.

[ApplicationStatusOverlay](/application/cerner-terra-application-docs/components/application-status-overlay) components rendered by children of the ApplicationStatusOverlayProvider will cause the
