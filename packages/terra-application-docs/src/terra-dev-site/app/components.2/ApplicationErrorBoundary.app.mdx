import PropsTable from '@cerner/terra-application/lib/application-error-boundary/ApplicationErrorBoundary?dev-site-props-table';
...
```jsx
import ApplicationErrorBoundary from '@cerner/terra-application/lib/application-error-boundary';
```
