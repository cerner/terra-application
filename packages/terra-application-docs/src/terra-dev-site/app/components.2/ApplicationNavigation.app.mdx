...
ApplicationNavigation renders an [ApplicationErrorBoundary](/application/cerner-terra-application-docs/components/application-error-boundary) around its children.
...
ApplicationNavigation renders an [ApplicationLoadingOverlayProvider](/application/cerner-terra-application-docs/components/application-loading-overlay-provider) around its children.
Any [ApplicationLoadingOverlay](/application/cerner-terra-application-docs/components/application-loading-overlay) components rendered by children will cause a loading overlay
...
ApplicationNavigation renders an [ApplicationStatusOverlayProvider](/application/cerner-terra-application-docs/components/application-status-overlay-provider) around its children.
Any [ApplicationStatusOverlay](/application/cerner-terra-application-docs/components/application-status-overlay) components rendered by children will cause a status view
to be presented over ApplicationNavigation's children.
...
ApplicationNavigation monitors its children for the presence of rendered [UnsavedChangesPrompts](/application/cerner-terra-application-docs/components/unsaved-changes-prompt)
by rendering a [UnsavedChangesPromptCheckpoint](/application/cerner-terra-application-docs/components/unsaved-checkpoint-prompt-checkpoint) around its children.
