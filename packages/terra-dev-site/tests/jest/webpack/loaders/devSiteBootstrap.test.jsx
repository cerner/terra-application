...
describe('devSiteBootstrap', () => {
  it('It fills out all the fields', (done) => {
    ...
    runLoaders({
      resource: `${path.resolve(__dirname, '..', '..', '..', '..', 'src', 'webpack', 'templates', 'bootstrap.template')}?query`,
      loaders: [
        {
          loader: path.resolve(__dirname, '../../../../src/webpack/loaders/devSiteBootstrap'),
          options: {
            bootstrapLoaderData: {
              '?query': {
                entryPath: 'entryPath',
