import PropsTable from '@cerner/terra-application/lib/modal-manager/ModalManager?dev-site-props-table';
...
ModalManager renders an [ApplicationErrorBoundary](/application/cerner-terra-application-docs/components/application-error-boundary)
...
ModalManager renders an [ApplicationLoadingOverlayProvider](/application/cerner-terra-application-docs/components/application-loading-overlay-provider)
...
ModalManager renders an [ApplicationStatusOverlayProvider](/application/cerner-terra-application-docs/components/application-status-overlay-provider)
...
ModalManager monitors its disclosed content for the presence of rendered [UnsavedChangesPrompts](/application/cerner-terra-application-docs/components/unsaved-changes-prompt)
...
The ModalManager utilizes the [DisclosureManagerContext](/application/cerner-terra-application-docs/contexts/disclosure-manager-context) to manage disclosure requests.
...
import ModalManager, { disclosureType } from '@cerner/terra-application/lib/modal-manager';
