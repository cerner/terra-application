...
> Note: An ActiveBreakpointContext.Provider is rendered by [ApplicationBase](/components/terra-application/application/reference/components/application-base).
