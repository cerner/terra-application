...
<!-- * Page error boundary/suspense implementation
  * SuspensePage - show loading overlay, disable buttons automatically during overlay presentation, callbacks when suspense fails
  * withPageErrorBoundary - HOC to wrap Page implementations with Page-presenting fallback
  * Page prop callback on interior error caught -->
* SessionContext
  * UserContext
  * SessionActionsContext
* Discuss purpose and placement of Error Boundaries within the framework in general
